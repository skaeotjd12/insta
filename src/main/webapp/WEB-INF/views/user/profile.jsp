	...
	<div class="profileContainer">
		...
		<div class="profile-right">
			...
			<div class="subscribe">
				<ul>
					<!--
				  view페이지에서 연산하는건 좋은 방법은 아니니 dto에서 만들어서온다
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<!-- EL표현식에서 변수명을 적으면 get함숙가 자동 호출된다. 그래서 image는 select할때 가팅 조인하는
						EAGER가아닌 LAGER를 써서 get함수로 호출해줘야하지만 따로 만들지않고 여기서 el문법을 써주면 자동
						get함수가 써져서 image 테이블을 조인해서 가져올수 있다.
				-->
				<c:forEach var="image" items="${dto.user.images}">
					<div class="img-box">
						<a href=""> <img src="/upload/${image.postImageUrl}" /> <!-- webMavConfig 발동 -->
						</a>
						<div class="comment">
